...
const LogoBookmark = ({ className, color, bg, icon }: ILogoBookmark) => {
  return (
    <svg width="148" height="25" className={className}>
      <g fill="none" fillRule="evenodd">
        <path
          ...
          fill={color ? color : "#242A45"}
          fillRule="nonzero"
        />
        <g>
          <circle fill={icon ? icon : "#5267DF"} cx="12.5" cy="12.5" r="12.5" />
          <path
...
const Hamburger = ({ className }: IIcons) => {
  return (
    <svg width="18" height="15" className={className}>
      <path
        fill="#242A45"
        fillRule="evenodd"
...
const Close = ({ className }: IIcons) => {
  return (
    <svg width="16" height="15" className={className}>
      <path
        fill="#FFF"
        fillRule="evenodd"
...
const Facebook = ({ className }: IIcons) => {
  return (
...
const Twitter = ({ className }: IIcons) => {
  return (
    <svg className={className} width="24" height="20">
      <path
        fillRule="evenodd"
...
const ArrowDown = ({ className }: IIcons) => {
  return (
    <svg className={className} width="18" height="12">
      <path fill="none" stroke="#5267DF" strokeWidth="3" d="M1 1l8 8 8-8" />
    </svg>
  );
};

const DotsHorizontal = ({ className }: IIcons) => {
  return (
    <svg className={className} width="280" height="4">
      <path
        fill="#495DCF"
        fillOpacity=".2"
        fillRule="evenodd"
...
const Chrome = ({ className }: IIcons) => {
  return (
    <svg className={className} width="102" height="100">
      <g fill="none">
        <path
          fill="#E16B5A"
...
const Firefox = ({ className }: IIcons) => {
  return (
    <svg className={className} width="105" height="100">
      <path
        fill="#FF9800"
...
const Opera = ({ className }: IIcons) => {
  return (
    <svg className={className} width="96" height="100">
      <path
        fill="#EB6060"
        fillRule="evenodd"
